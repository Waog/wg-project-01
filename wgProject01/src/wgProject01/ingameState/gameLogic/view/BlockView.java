...
public class BlockView {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((blockNode == null) ? 0 : blockNode.hashCode());
		result = prime * result
				+ ((faceNegativeX == null) ? 0 : faceNegativeX.hashCode());
		result = prime * result
				+ ((faceNegativeY == null) ? 0 : faceNegativeY.hashCode());
		result = prime * result
				+ ((faceNegativeZ == null) ? 0 : faceNegativeZ.hashCode());
		result = prime * result
				+ ((facePositiveX == null) ? 0 : facePositiveX.hashCode());
		result = prime * result
				+ ((facePositiveY == null) ? 0 : facePositiveY.hashCode());
		result = prime * result
				+ ((facePositiveZ == null) ? 0 : facePositiveZ.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (block == null) {
			...
			return false;
		if (blockNode == null) {
			if (other.blockNode != null)
				return false;
		} else if (!blockNode.equals(other.blockNode))
			return false;
		if (faceNegativeX == null) {
			if (other.faceNegativeX != null)
				return false;
		} else if (!faceNegativeX.equals(other.faceNegativeX))
			return false;
		if (faceNegativeY == null) {
			if (other.faceNegativeY != null)
				return false;
		} else if (!faceNegativeY.equals(other.faceNegativeY))
			return false;
		if (faceNegativeZ == null) {
			if (other.faceNegativeZ != null)
				return false;
		} else if (!faceNegativeZ.equals(other.faceNegativeZ))
			return false;
		if (facePositiveX == null) {
			if (other.facePositiveX != null)
				return false;
		} else if (!facePositiveX.equals(other.facePositiveX))
			return false;
		if (facePositiveY == null) {
			if (other.facePositiveY != null)
				return false;
		} else if (!facePositiveY.equals(other.facePositiveY))
			return false;
		if (facePositiveZ == null) {
			if (other.facePositiveZ != null)
				return false;
		} else if (!facePositiveZ.equals(other.facePositiveZ))
			return false;
		if (parentNode == null) {
